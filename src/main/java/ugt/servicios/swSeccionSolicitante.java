...
public class swSeccionSolicitante {
    ...
    //<editor-fold defaultstate="collapsed" desc="Buscar entidad perteneciente a solicitante con su rol">
    public static String buscarEntidadSolicitante(String cedula, String idrol) {
        String result = "";
        try {
            URL url = new URL(Constantes.PREFIJO + Constantes.IP + "/" + Constantes.SERVICIO + "/ws/bentidadusuario/" + cedula + "/" + idrol);
            HttpURLConnection conexion = (HttpURLConnection) url.openConnection();
            conexion.setRequestMethod("GET");
            conexion.setDoOutput(true);
            conexion.setDoInput(true);
            ...
            Logger.getAnonymousLogger().log(Level.SEVERE, "problemas en consultar el servicio para buscar entidad por cedula y por idrol ", e.getClass().getName() + "****" + e.getMessage());
            System.err.println("ERROR: " + e.getClass().getName() + "***" + e.getMessage());
        }
        return result;
    }
    ...
    //<editor-fold defaultstate="collapsed" desc="Buscar entidad perteneciente a solicitante con su charrol">
    public static String buscarEntidadUsuarioOpc(String cedula, String charrol) {
        String result = "";
        try {
            URL url = new URL(Constantes.PREFIJO + Constantes.IP + "/" + Constantes.SERVICIO + "/ws/bentidadusuarioopc/" + cedula + "/" + charrol);
            HttpURLConnection conexion = (HttpURLConnection) url.openConnection();
            conexion.setRequestMethod("GET");
            conexion.setDoOutput(true);
            conexion.setDoInput(true);

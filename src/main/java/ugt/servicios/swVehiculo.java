...
//            System.out.println(httpURLConnection.getResponseCode());
    ...
    //<editor-fold defaultstate="collapsed" desc="Buscar agenda de vehiculo por placaN">
    public static String buscarVehiculoAgenda(String placa) {
        String result = "";
        try {
            URL url = new URL(Constantes.PREFIJO + Constantes.IP + "/" + Constantes.SERVICIO + "/ws/bvehiculoagenda/"+placa);
            HttpURLConnection conexion = (HttpURLConnection) url.openConnection();
            conexion.setRequestMethod("GET");
            conexion.setDoOutput(true);
            conexion.setDoInput(true);
            ...
            Logger.getAnonymousLogger().log(Level.SEVERE, "problemas en consultar el servicio para buscar la agenda de un vehicular ", e.getClass().getName() + "****" + e.getMessage());
            System.err.println("ERROR: " + e.getClass().getName() + "***" + e.getMessage());
        }
        return result;
    }
